...
package ml // import "github.com/sunnogo/go-genproto/googleapis/cloud/ml/v1"
...
func (dst *SetDefaultVersionRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SetDefaultVersionRequest.Merge(dst, src)
}
